...
export default function DomainDetails() {
  ...
  // Buscar analytics reais do Supabase com lógica py/cy
  useEffect(() => {
    const fetchAnalytics = async () => {
      ...
      try {
        ...
        // Lógica PY/CY para os últimos 12 meses
        const now = new Date();
  ...
  const updateNameservers = async (nameservers: string[]) => {
              ...
              <div className="flex items-center justify-between">
                ...
                {!isEditingNameservers ? (
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button size="sm" onClick={handleSaveNameservers}>
                      Salvar
                    </Button>
                  </div>
                )}
